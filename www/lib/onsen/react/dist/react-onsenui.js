/*! react-onsenui v1.1.0 - Wed Jan 18 2017 05:31:58 GMT+0000 (UTC) */
...
var LazyList = function (_BasicComponent) {
  ...
  createClass(LazyList, [{
    ...
    value: function render() {
      ...
      return React.createElement('ons-list', _extends({}, this.props, { ref: function ref(list) {
          _this3._list = list;
        },
...
var List = function (_BasicComponent) {
  ...
  createClass(List, [{
    ...
    value: function render() {
      ...
      return React.createElement('ons-list', _extends({}, this.props, { ref: function ref(list) {
          _this2._list = list;
        } }), this.props.renderHeader(), pages, this.props.children, this.props.renderFooter());
    }
  }]);
  return List;
}(BasicComponent);
...
var Navigator$1 = function (_BasicComponent) {
  ...
  createClass(Navigator, [{
    ...
    value: function render() {
      ...
      return React.createElement('ons-navigator', _extends({}, others, { ref: function ref(navi) {
          _this8._navi = navi;
        } }), pages);
    }
  }]);
...
var RouterNavigator = function (_BasicComponent) {
  ...
  function RouterNavigator(props) {
    ...
    var _this = possibleConstructorReturn(this, (RouterNavigator.__proto__ || Object.getPrototypeOf(RouterNavigator)).call(this, props));
...
var Tabbar = function (_BasicComponent) {
  ...
  createClass(Tabbar, [{
    ...
    value: function render() {
      ...
      return React.createElement('ons-tabbar', _extends({}, this.props, { ref: function ref(tabbar) {
          _this3._tabbar = tabbar;
        } }), React.createElement('div', { className: 'ons-tab-bar__content tab-bar__content' + (this.props.position === 'top' ? ' tab-bar--top__content' : '') }, this.tabPages), React.createElement('div', { className: 'tab-bar ons-tab-bar__footer ons-tabbar-inner' + (this.props.position === 'top' ? ' tab-bar--top' : '') }, tabs.map(function (tab) {
        return tab.tab;
      })));
    }
  }]);
